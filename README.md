This script is used on a new install of Ubuntu 24.04 LTS to complete the setup and basic security of the OS. 
...
Download the script
```
wget -O /tmp/Ubuntu24Setup.sh https://raw.githubusercontent.com/alexlewislnk/Ubuntu-Setup/main/Ubuntu24Setup.sh
